...
class controllerCiscodnssingle extends Controller
{
    public function run()
    {
        // Get form data
        ...
        $command = sprintf('ansible-playbook %s -e ansible_become_password=%s -e ansible_user=%s -e ansible_password=%s -e client_ip=%s -e dns_server_ip=%s', $playbookPath, $ansible_become_password, $ansible_user, $ansible_password, $clientIp, $dnsServerIp );
