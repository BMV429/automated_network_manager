...
class controllerCiscosnmpsingle extends Controller
{
    public function run()
    {
        // Get form data
        ...
        $command = sprintf('ansible-playbook %s -e ansible_become_password=%s -e ansible_ssh_user=%s -e ansible_ssh_pass=%s -e user=%s -e group=%s -e authpass=%s -e privpass=%s -e client_ip=%s ', $playbookPath, $ansible_become_password, $ansible_ssh_user, $ansible_ssh_pass, $user, $group, $authpass, $privpass, $clientIp);
